...
import 'package:patchwing_build_trace/src/build_trace_event.dart';

/// Patchwing convention: all events from one producer share a single pid
...
class BuildTracer {
  ...
  /// emit with the same [id]. Patchwing convention uses the child's pid
