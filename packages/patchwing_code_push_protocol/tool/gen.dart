// Regeneration entrypoint for the patchwing_code_push_protocol package.
//
// Plugs a Patchwing-specific [FileRenderer] into space_gen's standard
...
//     -i https://api.patchwing.dev/openapi.json \
//     -o packages/patchwing_code_push_protocol
//
// The generator does not touch `lib/extensions/` or
// `lib/patchwing_code_push_protocol.dart`; those are hand-written and
// re-export the generated types.

import 'package:space_gen/space_gen.dart';

class PatchwingFileRenderer extends FileRenderer {
  PatchwingFileRenderer(super.config);
  ...
  @override
  String testBarrelImport() => 'patchwing_code_push_protocol.dart';
...
Future<int> main(List<String> arguments) =>
    runCli(arguments, fileRendererBuilder: PatchwingFileRenderer.new);
