...
BuildEnvironmentMetadata _$BuildEnvironmentMetadataFromJson(
  ...
  ($checkedConvert) {
    final val = BuildEnvironmentMetadata(
      ...
      patchwingVersion: $checkedConvert(
        'patchwing_version',
        (v) => v as String,
      ),
      ...
      patchwingYaml: $checkedConvert(
        'patchwing_yaml',
        (v) => PatchwingYaml.fromJson(v as Map<String, dynamic>),
      ),
      usesPatchwingCodePushPackage: $checkedConvert(
        'uses_patchwing_code_push_package',
        (v) => v as bool,
      ),
  ...
  fieldKeyMap: const {
    ...
    'patchwingVersion': 'patchwing_version',
    'operatingSystem': 'operating_system',
    'operatingSystemVersion': 'operating_system_version',
    'patchwingYaml': 'patchwing_yaml',
    'usesPatchwingCodePushPackage': 'uses_patchwing_code_push_package',
...
Map<String, dynamic> _$BuildEnvironmentMetadataToJson(
  ...
  'patchwing_version': instance.patchwingVersion,
  'operating_system': instance.operatingSystem,
  'operating_system_version': instance.operatingSystemVersion,
  'patchwing_yaml': instance.patchwingYaml.toJson(),
  'uses_patchwing_code_push_package': instance.usesPatchwingCodePushPackage,
