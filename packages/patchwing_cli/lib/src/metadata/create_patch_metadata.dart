...
import 'package:patchwing_cli/src/metadata/build_environment_metadata.dart';
...
class CreatePatchMetadata extends Equatable {
  ...
  ///
  /// Reason: patchwing does not support asset changes in patches, and knowing
  ...
  ///
  /// Reason: patchwing does not support native code changes in patches, and
  /// knowing that native code changes were detected can help explain unexpected
  /// behavior in a patch.
  final bool hasNativeChanges;

  /// Whether the release version had to be inferred by Patchwing because
