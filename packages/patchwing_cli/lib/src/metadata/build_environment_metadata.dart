...
///
/// Collection of this information is done to help Patchwing users debug any
...
class BuildEnvironmentMetadata extends Equatable {
  ...
  const BuildEnvironmentMetadata({
    ...
    required this.patchwingVersion,
    required this.operatingSystem,
    required this.operatingSystemVersion,
    required this.patchwingYaml,
    required this.usesPatchwingCodePushPackage,
    this.xcodeVersion,
  });
  ...
  factory BuildEnvironmentMetadata.forTest({
    ...
    String patchwingVersion = '4.5.6',
    String operatingSystem = 'macos',
    String operatingSystemVersion = '1.2.3',
    PatchwingYaml patchwingYaml = const PatchwingYaml(appId: '123'),
    bool usesPatchwingCodePushPackage = false,
    String? xcodeVersion = '15.0',
  }) => BuildEnvironmentMetadata(
    flutterRevision: flutterRevision,
    patchwingVersion: patchwingVersion,
    operatingSystem: operatingSystem,
    operatingSystemVersion: operatingSystemVersion,
    patchwingYaml: patchwingYaml,
    usesPatchwingCodePushPackage: usesPatchwingCodePushPackage,
  ...
  BuildEnvironmentMetadata copyWith({
    ...
    String? patchwingVersion,
    String? operatingSystem,
    String? operatingSystemVersion,
    PatchwingYaml? patchwingYaml,
    bool? usesPatchwingCodePushPackage,
    String? xcodeVersion,
  }) => BuildEnvironmentMetadata(
    flutterRevision: flutterRevision ?? this.flutterRevision,
    patchwingVersion: patchwingVersion ?? this.patchwingVersion,
    operatingSystem: operatingSystem ?? this.operatingSystem,
    operatingSystemVersion:
        operatingSystemVersion ?? this.operatingSystemVersion,
    patchwingYaml: patchwingYaml ?? this.patchwingYaml,
    usesPatchwingCodePushPackage:
        usesPatchwingCodePushPackage ?? this.usesPatchwingCodePushPackage,
  ...
  /// which are tied to a flutter revision as opposed to a patchwing version.
  final String flutterRevision;

  /// The version of Patchwing used to run the command.
  ///
  /// Reason: each version of patchwing has new features and bug fixes. Users
  /// using an older version may be running into issues that have already been
  /// fixed.
  final String patchwingVersion;
  ...
  final PatchwingYaml patchwingYaml;

  /// Whether the project uses package:patchwing_code_push.
  ///
  /// Reason: this helps us understand which projects are using the Patchwing
  /// CodePush package and better support customers who encounter issues.
  final bool usesPatchwingCodePushPackage;
  ...
  /// `patchwing preview` mechanism changed entirely between Xcode 14 and 15.
