...
part of 'patchwing_yaml.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PatchwingYaml _$PatchwingYamlFromJson(Map json) => $checkedCreate(
  'PatchwingYaml',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$PatchwingYamlToJson(
  PatchwingYaml instance,
) => <String, dynamic>{
