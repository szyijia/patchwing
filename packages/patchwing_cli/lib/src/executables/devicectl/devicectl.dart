...
import 'package:patchwing_cli/src/executables/devicectl/nserror.dart';
import 'package:patchwing_cli/src/executables/idevicesyslog.dart';
...
class Devicectl {
  ...
  Future<int> installAndLaunchApp({
    ...
    // in missing some patchwing logs.
