...
/// Manages artifacts for the Patchwing CLI.
class ArtifactManager {
  /// Generates a binary diff between two files and returns the path to the
  /// output diff file.
  /// 使用 engine 的 bidiff+zstd patch 工具，输出已经是 zstd 压缩的 bipatch 格式。
  ...
  static Directory? androidArchsDirectory({
    ...
    //
    // See https://github.com/patchwingtech/patchwing/issues/1798
  ...
  /// Returns the patchwing release supplement directory for the given
  ...
  /// Returns the path to the patchwing release supplement directory for iOS.
  ///
  ...
  /// Returns the path to the patchwing release supplement directory for macOS.
  ///
  /// Returns null if there is no supplement directory
  /// (e.g. when using older Flutter revisions).
  ...
  /// Name of the App.xcframework generated by `patchwing release ios-framework`
  static const String appXcframeworkName = 'App.xcframework';

  /// Returns the path to the App.xcframework generated by
  /// `patchwing release ios-framework` or
  /// `patchwing patch ios-framework`.
