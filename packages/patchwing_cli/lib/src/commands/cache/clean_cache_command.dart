...
/// `patchwing cache clean`
/// Clears the Patchwing cache directory.
/// {@endtemplate}
class CleanCacheCommand extends PatchwingCommand {
  ...
  Future<int> run() async {
    ...
    try {
      ...
      final cachePath = Cache.patchwingCacheDirectory.path;
