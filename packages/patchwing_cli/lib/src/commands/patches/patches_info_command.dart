...
/// `patchwing patches info`
/// Show details for a specific patch.
/// {@endtemplate}
class PatchesInfoCommand extends PatchwingCommand {
  ...
  String get description =>
      ...
      '    ios      arm64        896 KB\n\n'
      '${PatchwingCommand.jsonHint('patchwing patches info --release-version 1.0.0+1 --patch-number 1 --app-id <id> --json')}';
