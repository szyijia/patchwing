...
/// Sample usage:
/// ```sh
/// patchwing patches set-track --release=1.0.0+1 --patch=1 --track=beta
/// ```
///
/// {@endtemplate}
class SetTrackCommand extends PatchwingCommand {
  ...
  String get description =>
      ...
      '${PatchwingCommand.jsonHint('patchwing patches set-track --release 1.0.0+1 --patch 1 --track stable --app-id <id> --json')}';
