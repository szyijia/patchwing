...
abstract class Releaser {
  ...
  /// Instructions explaining next steps after running `patchwing release`. This
  ...
  /// passed either to Patchwing directly or forwarded to Flutter.
  bool get useObfuscation => argResults.flagPresent('obfuscate');

  /// DD table cascade byte threshold for the release build.
  ///
  /// Passed to Flutter tools via the PATCHWING_DD_MAX_BYTES environment
  ...
  /// 'ios'). Used to construct `build/<platformSubdir>/patchwing/`.
  ...
  // https://github.com/patchwingtech/patchwing/issues/3630
