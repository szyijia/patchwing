...
class MacosPatcher extends Patcher
  ...
  String get _arm64AotOutputPath =>
      p.join(patchwingEnv.buildDirectory.path, 'out.arm64.aot');

  // The elf snapshot built for Intel macs.
  String get _x64AotOutputPath =>
      p.join(patchwingEnv.buildDirectory.path, 'out.x64.aot');
  ...
  @override
  String? get localPodfileLockHash => patchwingEnv.macosPodfileLockHash;
...
For more information see: ${supportedFlutterVersionsUrl.toLink()}''');
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: PatchwingArtifact.genSnapshotMacosArm64,
      additionalArgs: [
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: PatchwingArtifact.genSnapshotMacosX64,
      additionalArgs: [
        ...ApplePatcherMixin.splitDebugInfoArgs(splitDebugInfoPath),
        ...obfuscationGenSnapshotArgs,
      ],
