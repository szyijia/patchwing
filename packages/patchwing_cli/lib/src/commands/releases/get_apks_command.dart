...
import 'package:patchwing_cli/src/executables/bundletool.dart';
...
/// {@endtemplate}
class GetApksCommand extends PatchwingCommand {
  ...
  Future<int> run() async {
    ...
    if (outDirectoryArg != null) {
      ...
      // so we move the generated apk to build/app/outputs/patchwing-apk.
      outputDirectory = Directory(
        p.join(
          patchwingEnv.getPatchwingProjectRoot()!.path,
          'build',
          'app',
          'outputs',
          'patchwing-apk',
