...
import 'package:patchwing_cli/src/extensions/file.dart';
...
extension OptionFinder on ArgResults {
  ...
  ///
  /// Use this for flags that Patchwing and Flutter both understand
...
extension ForwardedArgs on ArgResults {
  ...
  /// A list of arguments parsed by Patchwing commands that will be forwarded
