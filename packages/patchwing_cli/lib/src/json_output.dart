...
/// (e.g. "doctor" for `patchwing doctor`, "patch ios" for `patchwing patch ios`).
///
/// Returns `null` when no subcommand was recognized (bare `patchwing` invocation).
