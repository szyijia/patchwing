...
/// The reference to the [PatchwingAndroidArtifacts] instance.
final patchwingAndroidArtifactsRef = create(PatchwingAndroidArtifacts.new);

/// The [PatchwingAndroidArtifacts] instance available in the current zone.
PatchwingAndroidArtifacts get patchwingAndroidArtifacts =>
    read(patchwingAndroidArtifactsRef);

/// Mixin on [PatchwingCommand] which exposes methods
// to find the artifacts generated for android
class PatchwingAndroidArtifacts {
