...
class BuildTraceSession {
  ...
  /// The wall-clock time at which the current `patchwing` invocation began.
  final DateTime commandStartedAt;

  /// The Chrome Trace Event Format JSON file that producers
  /// (`flutter build --patchwing-trace`, `aot_tools --trace`, and
  /// patchwing_cli's own spans) append to. Null when tracing is not
