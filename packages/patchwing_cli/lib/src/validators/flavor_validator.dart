...
/// Verifies that the flavors in the Patchwing configuration match the
...
class FlavorValidator extends Validator {
  ...
  Future<List<ValidationIssue>> validate() async {
    ...
    final projectFlavors = patchwingYaml.flavors;
...
The default app id ${patchwingYaml.appId} will be used.''',
        ),
      ];
    }
