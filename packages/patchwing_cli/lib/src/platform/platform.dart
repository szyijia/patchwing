export 'package:patchwing_cli/src/flutter_version_constraints.dart';
...
/// {@template arch}
/// Build architectures supported by Patchwing.
///
...
enum Arch {
  ...
  /// The name used by Patchwing to identify this architecture.
  final String arch;
}
