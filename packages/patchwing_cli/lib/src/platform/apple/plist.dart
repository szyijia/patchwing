...
import 'package:patchwing_cli/src/platform/apple/invalid_export_options_plist_exception.dart';
...
class Plist {
  ...
  /// number on App Store Connect. This breaks Patchwing, because the build
  /// number that ships will not match the one Patchwing recorded for the
  /// release.
  ///
...
/// ships to App Store Connect will not match the build number Patchwing
