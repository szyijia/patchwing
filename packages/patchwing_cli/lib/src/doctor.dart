...
No issues detected!''');
      ...
      if (allFixableIssues.isNotEmpty && !applyFixes) {
        ...
        logger.info(
          '''
$fixableIssueCount issue${fixableIssueCount == 1 ? '' : 's'} can be fixed automatically with ${lightCyan.wrap('patchwing doctor --fix')}.''',
        );
      }
    }
  }
