...
class ArtifactManager {
  ...
  /// Returns the pw release supplement directory for the given
  ...
  /// Returns the path to the pw release supplement directory for iOS.
  ///
  ...
  /// Returns the path to the pw release supplement directory for macOS.
  ///
  /// Returns null if there is no supplement directory
  /// (e.g. when using older Flutter revisions).
  ...
  /// Name of the App.xcframework generated by `pw release ios-framework`
  static const String appXcframeworkName = 'App.xcframework';

  /// Returns the path to the App.xcframework generated by
  /// `pw release ios-framework` or
  /// `pw patch ios-framework`.
