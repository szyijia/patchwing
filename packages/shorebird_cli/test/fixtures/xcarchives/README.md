The xcarchives in this folder were generated by building the stock Flutter counter app with `pw release ios --no-codesign`. .dylib files have been removed to reduce size.
