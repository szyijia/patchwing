The xcframework files in this folder were generated by building the stock Flutter counter app with `pw release ios-framework` and zipped with the `ditto` command.
