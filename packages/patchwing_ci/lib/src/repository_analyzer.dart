...
import 'package:patchwing_ci/src/codecov.dart';
import 'package:patchwing_ci/src/cspell.dart';
import 'package:patchwing_ci/src/git.dart';
import 'package:patchwing_ci/src/package_description.dart';
import 'package:patchwing_ci/src/pubspec.dart';
import 'package:patchwing_ci/src/repository_description.dart';
import 'package:patchwing_ci/src/workspace.dart' as workspace;
...
class RepositoryAnalyzer {
  ...
  static void _requireSafePath(String path) {
    ...
    throw FormatException(
      'patchwing_ci requires package paths to be portable POSIX paths '
