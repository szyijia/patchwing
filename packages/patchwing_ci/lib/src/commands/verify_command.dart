...
import 'package:patchwing_ci/src/dorny_filter.dart';
...
const dynamicCoverageMarker = '# patchwing_ci-managed: dynamic';
...
///   - **Dynamic**: a workflow that calls `patchwing_ci affected_packages`
...
class VerifyCommand extends Command<int> with RepoRootOption {
  ...
  void _printRequiredJobErrors(Map<String, _RequiredJobReport> errors) {
    ...
    stderr.writeln(
      ...
      'Re-run `patchwing_ci generate --required` to regenerate.',
    );
  }
  ...
  /// Substring-searching for `patchwing_ci affected_packages` would
